var EightyApp = function() {
    this.processDocument = function(html, url, headers, status, jQuery) {
        ...
        var object = {};
        var tmp = {};
        object.crawed_at = app.formatDate(Date());
        // page basics
        ...
        object.pub_date = tmp.parsely_pubdate || tmp.sailthru_date || tmp.og_published_time || tmp.meta_date || tmp.meta_article_date_original || tmp.meta_article_published_time || tmp.meta_publication_date || tmp.meta_publishdate || tmp.meta_display_date;
        ...
        object.page_type = tmp.parsely_type || tmp.og_type;
